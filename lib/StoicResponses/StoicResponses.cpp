...
const String StoicResponses::happyness[] = {
    ...
    "Those are great news! There's nothing better than having a good day. Just remember that life is full of ups and downs, so take a moment to enjoy and appreciate these moments.",
    "I'm happy for you. We both know that life can be hard, and these happy days are what help carry us through. Cherish them, and share that happiness with the people you love."

};

const String StoicResponses::happynessrecom[] = {
    "I recommend going out and doing some exercise. Use that great energy to burn some calories and take care of your health. And don't forget to drink some water on your way out!",
    "I recommend going out and spending some time in nature. Even if you live in a city, try to find a park or spend some time near the ocean. Take a moment to slow down and simply enjoy where you are.",
